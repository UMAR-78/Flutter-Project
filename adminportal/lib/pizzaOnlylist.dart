import 'package:adminportal/AddCart.dart';
import 'package:flutter/material.dart';
import 'package:cloud_firestore/cloud_firestore.dart';
import 'models/product.dart';
import 'models/fav.dart';

class PizzaListUser extends StatefulWidget {
  final String userId;

  PizzaListUser({required this.userId});

  @override
  _ProductListState createState() => _ProductListState();
}

class _ProductListState extends State<PizzaListUser> {
 ...
 Future<void> _fetchData() async {
  // Fetch products with name containing "Pizza"
  QuerySnapshot productSnapshot = await FirebaseFirestore.instance.collection('products').where('name', isEqualTo: 'Pizza').get();
