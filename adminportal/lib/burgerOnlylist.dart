...
class BurgerListUser extends StatefulWidget {
  final String userId;

  BurgerListUser({required this.userId});

  @override
  _ProductListState createState() => _ProductListState();
}

class _ProductListState extends State<BurgerListUser> {
 ...
 Future<void> _fetchData() async {
  ...
  QuerySnapshot productSnapshot = await FirebaseFirestore.instance.collection('products').where('name', isEqualTo: 'Burger').get();
